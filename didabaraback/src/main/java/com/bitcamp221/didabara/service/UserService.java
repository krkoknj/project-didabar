...
public class UserService {
    ...
    final String s3Path = "https://didabara.s3.ap-northeast-2.amazonaws.com/myfile/";

    final String defaultImage = "def54545-1d55-43b5-9f69-eb15c7ebe43f.jpg";
...
//    matches
    ...
    public UserDTO createKakaoUser(String token) throws IOException {
        ...
        if (userRepository.findByUsername(email) == null) {
            ...
            Long lastIndex = extracted();

            UserEntity user = getUserEntity(id, nickname, email, lastIndex);
            String find_user_token = tokenProvider.create(user);
            System.out.println("find_user_token = " + find_user_token);

            userRepository.save(user);

            UserInfoEntity userInfo = getUserInfoEntity(profile_image, user);
            ...
            UserEntity user = getUserEntity(id, nickname, email, byUsername.getId());
            String find_user_token = tokenProvider.create(user);
            System.out.println("find_user_token = " + find_user_token);
            br.close();
    ...
    private UserInfoEntity getUserInfoEntity(String profile_image, UserEntity user) {
    ...
    private UserEntity getUserEntity(Long id, String nickname, String email, Long lastIndex) {
